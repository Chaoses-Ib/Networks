...
= Transport
- #a[Documentation for L4 API (TCP/UDP) - Issue \#115][https://github.com/cloudflare/pingora/issues/115]
  - #a[`pingora/pingora/examples/server.rs`][https://github.com/cloudflare/pingora/blob/main/pingora/examples/server.rs]
- #a[HAProxy PROXY protocol v1/v2 support - Issue \#132][https://github.com/cloudflare/pingora/issues/132]
- #a[Support proxy tcp traffic - Issue \#317][https://github.com/cloudflare/pingora/issues/317]
